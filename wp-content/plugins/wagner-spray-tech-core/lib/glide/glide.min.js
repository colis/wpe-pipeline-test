...
! ( function ( t, e ) {
	...
	function y( t, e, n ) {
		...
		for ( var r in e )
			p( e[ r ] )
				? ( i[ r ] = e[ r ]( t, i, n ) )
				: f( 'Extension must be a function' );
				...
				i( t, [
					...
					},
					{
						...
						set: function ( t ) {
							v( t )
								? ( this._o = t )
								: f( 'Options must be an `object` instance.' );
						},
					},
					{
						key: 'index',
			...
			Html: function ( t, e, n ) {
				var i = {
					...
					collectSlides: function () {
						this.slides = A( this.wrapper.children ).filter(
							function ( e ) {
			...
			Translate: function ( t, e, n ) {
				...
				return (
					n.on( 'move', function ( r ) {
						...
						var o =
							e.Sizes.slideWidth * e.Translate.getStartIndex();
			...
			Sizes: function ( t, e, n ) {
				var i = {
					...
					setupWrapper: function () {
						e.Html.wrapper.style.width = ''.concat(
							this.wrapperSize,
							'px'
						);
					},
			...
			Clones: function ( t, e, n ) {
				...
				return (
					b( i, 'grow', {
						get: function () {
							return (
								( e.Sizes.slideWidth + e.Gaps.value ) *
								i.items.length
							);
						},
					} ),
				...
				var i = new R(),
					...
					c = {
						...
						unbindSwipeStart: function () {
							i.off( I[ 0 ], e.Html.wrapper, u ),
								i.off( I[ 1 ], e.Html.wrapper, u );
						},
			...
			Anchors: function ( t, e, n ) {
				var i = new R(),
					...
					s = {
						mount: function () {
							( this._a =
								e.Html.wrapper.querySelectorAll( 'a' ) ),
								this.bind();
						},
						bind: function () {
